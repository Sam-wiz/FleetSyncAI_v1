    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 grid grid-cols-2 gap-8 p-8">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-lg font-medium">Total Capacity: 1500</div>
        </div>
        <div className="grid grid-cols-2 gap-8">
          <div className="flex flex-col items-center justify-center">
            <div className="text-4xl font-bold">25</div>
            <div className="text-lg font-medium">Truck Arrivals</div>
          </div>
          <div className="flex flex-col items-center justify-center">
            <div className="text-4xl font-bold">15</div>
            <div className="text-lg font-medium">Truck Departures</div>
          </div>
          <div className="flex flex-col items-center justify-center">
            <div className="text-4xl font-bold">1500</div>
            <div className="text-lg font-medium">Total Goods</div>
          </div>
        </div>
      </main>
    </div>
